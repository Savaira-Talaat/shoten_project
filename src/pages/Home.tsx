...
import type { recentUpdates } from "../types/recentUpdates";

export default function Accueil() {
  const [changementsRecents, setChangementsRecents] = useState<recentUpdates[]>([]);
  ...
  useEffect(() => {
    async function chargerChangementsRecents() {
      try {
        ...
        const donnees: recentUpdates[] = await reponse.json();
